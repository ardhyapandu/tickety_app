<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            Event &raquo; {{ $event->name }} &raquo; Tiket &raquo; {{ isset($ticket) ? 'Edit' : 'Buat' }}
        </h2>
    </x-slot>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden shadow sm:rounded-md">
                <div class="px-4 py-5 bg-white sm:p-6">
                    <form 
                        method="POST"
                        action="{{ isset($ticket) ? route('admin.events.tickets.update', [
                                'event' => $event->id,
                                'ticket' => $ticket->id,
                            ])
                    ...
                    >
                        ...
                        {{-- Name --}}
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm">Nama Tiket</label>
                            <input 
                                type="text"
                                name="name"
                        ...
                        {{-- Max Buy --}}
                        <div class="mb-6">
                            <label for="max_buy" class="block mb-2 text-sm">Maksimal Pembelian</label>
                            <input 
                                type="text"
                                name="max_buy"
                                class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5"
