@props([
    'isPopular' => false,
    'cover' => asset('assets/images/event-1.webp'),
    'title',
    'category',
    'date',
    'price',
...
<div class="group rounded-2xl w-full overflow-hidden relative min-h-[297px] bg-primary">
    ...
    {{-- <img src="" class="w-full h-full max-h-[205px]" alt="tickety-assets" /> --}}
    <div class="p-5 w-full bg-primary flex flex-col absolute h-full group-hover:-translate-y-[70%] transition ease-in-out duration-300">
        ...
        <p class="mt-4 text-base leading-7 transition duration-300 ease-in-out opacity-0 text-iron-grey group-hover:opacity-100 line-clamp-3">
            {{ $description }}
        </p>
