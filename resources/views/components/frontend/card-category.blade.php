...
<div class="p-5 bg-primary rounded-2xl relative inline-flex gap-[14px] items-center w-full hover:ring-2 hover:ring-butter-yellow transition ease-in-out duration-300 group">
    <a href="{{ $route }}" class="after:absolute after:inset-0">
    ...
    <img 
        src="{{ asset('assets/svgs/ic-arrow-right.svg') }}"
